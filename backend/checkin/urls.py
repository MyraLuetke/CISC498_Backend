...
urlpatterns = [
    ...
    path('checkin/business/customer_exists/', views.CustomerDetailEmail.as_view()),
    path('checkin/business/checkin_customer/', views.BusinessAddVisitCreate.as_view()),
    path('checkin/business/checkin_manual/', views.BusinessAddUnregisteredVisitCreate.as_view()),
